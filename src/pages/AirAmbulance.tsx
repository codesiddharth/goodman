import { Plane, Shield, Clock, Activity, CheckCircle2, PhoneCall } from 'lucide-react';
    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div ref={heroRef} className="bg-primary-950 py-24 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <motion.img 
            style={{ y }}
            src="https://picsum.photos/seed/airambulancejet/1920/1080" 
        ...
        <motion.div {...fadeUp} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center space-x-2 bg-primary-800/50 rounded-full px-4 py-2 mb-6 border border-primary-700 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-primary-100">Premium Aeromedical Transport</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6 leading-tight">
              Specialized Air Ambulance Services
            </h1>
            <p className="text-xl text-primary-100 mb-8 leading-relaxed">
              When time is of the essence, our flying ICUs and expert medical teams provide the safest, fastest patient transport across the globe.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              >
                ...
                <span>Call for Immediate Evacuation</span>
              </a>
            </div>
          </div>
        </motion.div>
      ...
      <section className="py-16 bg-white border-b border-gray-100 relative z-20 -mt-8 mx-4 sm:mx-6 lg:mx-8 rounded-2xl shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { icon: Activity, title: "Flying ICU", desc: "Fully equipped with ventilators, monitors, and life-saving drugs." },
              { icon: Shield, title: "Doctor-Led", desc: "Specialized doctors and flight nurses on every mission." },
              { icon: Clock, title: "Rapid Response", desc: "Wheels up in as little as 2-4 hours for critical emergencies." },
              { icon: Plane, title: "Bed-to-Bed", desc: "Seamless transfer including ground ambulances at both ends." }
            ].map((feature, idx) => (
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-6">Our Bed-to-Bed Transfer Process</h3>
            <p className="text-lg text-gray-600">
              We handle every logistical and medical detail so you can focus on your loved one.
            </p>
          </motion.div>
          ...
          <div className="relative">
            ...
            >
              {[
                { step: "01", title: "Medical Assessment", desc: "Our doctors consult with the treating physician to determine fitness to fly and equipment needed." },
                { step: "02", title: "Logistics & Clearance", desc: "We secure flight permits, airport slots, and arrange ground ambulances at origin and destination." },
                { step: "03", title: "The Transfer", desc: "Our medical team arrives at the hospital, takes over care, and safely transports the patient via aircraft." },
                { step: "04", title: "Safe Admission", desc: "We hand over the patient directly to the receiving medical team at the destination hospital." }
              ].map((item, idx) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-primary-600 font-semibold tracking-wide uppercase text-sm mb-3">Our Fleet Capabilities</h2>
              <h3 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-6">Aircraft Equipped for Critical Care</h3>
              <p className="text-lg text-gray-600 mb-8">
                Depending on the patient's condition, distance, and budget, we utilize various types of aircraft, all configured with state-of-the-art medical equipment.
              </p>
              
              <ul className="space-y-4">
                {[
                  "Turboprop Aircraft (King Air C90/B200) for short to medium domestic sectors.",
                  "Light Jets (Citation, Learjet) for faster regional transfers.",
                  "Mid-size & Heavy Jets (Challenger, Falcon) for long-haul international flights.",
                  "Commercial Airline Stretcher installations for cost-effective international transport of stable patients."
                ].map((item, idx) => (
      ...
      <section className="bg-primary-900 py-20 relative overflow-hidden">
        ...
        <motion.div {...fadeUp} className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-6">Need an Air Ambulance Quote?</h2>
          <p className="text-primary-100 text-lg mb-10">
            Our medical directors are available 24/7 to evaluate the patient's condition and provide a comprehensive transport plan and cost estimate.
          </p>
